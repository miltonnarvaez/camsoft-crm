...
function parseCorsOrigins() {
    const raw = process.env.CORS_ORIGIN || 'https://camsoft.com.co,https://crm.camsoft.com.co';
    const list = raw.split(',').map((s) => s.trim()).filter(Boolean);
    ['https://camsoft.com.co', 'https://crm.camsoft.com.co', 'http://localhost:5173', 'http://127.0.0.1:5173']
        .forEach((o) => { if (!list.includes(o)) list.push(o); });
    return list;
}
